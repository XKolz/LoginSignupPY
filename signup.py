...
def connect_database():
    if emailEntry.get() == '' or usernameEntry.get() == '' or passwordEntry.get() == '' or confirmpasswordEntry.get() == '':
        ...
        if row !=None:
            messagebox.showinfo('Success', 'Username already exists')
        else:
...
check = IntVar()
termsandcondition = Checkbutton(frame, text='I accept to the terms and conditions', font=('Microsoft Yahei UI Light', 9, 'bold')
...
signupButton = Button(frame, text='Signup', font=('Open Sans', 16, 'bold'), bd=0, bg='firebrick1', fg='white'
                      , activebackground='firebrick1', activeforeground='white', width=17, highlightbackground='firebrick1', command=connect_database)
signupButton.grid(row=10, column=0, sticky='w', padx=25)
