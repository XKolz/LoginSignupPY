...
def forget_pass():
    def change_password():
        if user_entry.get()=='' or newpass_entry.get()=='' or confirmpass_entry.get()=='':
            ...
            con = pymysql.connect(host='localhost', user='root', password='Kinging10', database='userdata')
            mycursor = con.cursor()
    ...
    submitButton = Button(window, text='Submit', bd=0, bg='magenta2', fg='magenta2', font=('Open Sans', 16, 'bold'),
                          width=19, cursor='hand2', activeforeground='magenta2', activebackground='magenta2',
                          highlightbackground='magenta2', command=change_password)
...
def login_user():
    if usernameEntry.get()=='' or passwordEntry.get()=='':
        ...
        try:
            con=pymysql.connect(host='localhost', user='root', password='Kinging10')
            mycursor=con.cursor()
        except:
...
usernameEntry = Entry(login_window, width=25, font=('Microsoft Yahei UI Light', 11, 'bold')
                      , bd=0, highlightthickness=0, fg='firebrick1')
...
eyeButton = Button(login_window, image=openeye, bd=0, bg='white', activebackground='white'
                   , cursor='hand2', command=hide, highlightthickness=0, fg='firebrick1', pady=0, padx=0)
...
forgetButton = Button(login_window, text='Forget Password?', bd=0, bg='white', activebackground='white'
                      ...
                      highlightthickness=0, fg='firebrick1', activeforeground='firebrick1', borderwidth=0, pady=0, padx=0, command=forget_pass)
forgetButton.place(x=715, y=295)

loginButton=Button(login_window, text='Login', font=('Open Sans', 16, 'bold'),
                   fg='white', bg='firebrick1', activeforeground='white',
                   activebackground='firebrick1', cursor='hand2', bd=0, width=19, highlightbackground='firebrick1', command=login_user)
